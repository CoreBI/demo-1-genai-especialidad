...
# Límite máximo de tokens permitido por el modelo
MAX_TOKENS = 32760
...
def dialogflow_webhook(request):
    ...
    model = GenerativeModel(model_name=  "gemini-2.5-pro", generation_config= generation_config, safety_settings= safety_settings)
...
# Verifica si el conteo de tokens excede el límite 
